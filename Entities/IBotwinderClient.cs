...
namespace Botwinder.entities
{
	public interface IBotwinderClient<TUser> where TUser : UserData, new()
	{
		...
		void LogMessage(LogType logType, SocketTextChannel channel, guid authorId, string message);
		void LogMessage(LogType logType, SocketTextChannel channel, SocketMessage message);
